...
import { Heading, Service } from "../index";
...
export const services = [
  ...
  },
  {
    ...
    description:
      "Tiene como finalidad la determinación de los principales impactos ambientales que la ejecución del proyecto genere en el ambiente, así como las medidas preventivas y correctivas para la mitigación de aquellos de carácter negativo. ",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description:
      "Hacemos un documento técnico dónde definimos las características que debe tener una instalación de red eléctrica para un loteo.",
  },
  {
    id: 7,
    ...
    description:
      "Desarrollo de la red de gas natural para un loteo por medio de un sistema de suministro de gases y abastecimiento constante en diversos puntos de sus instalaciones, en un alto volumen y buenas condiciones de presión.",
  },
  {
    id: 8,
    ...
    description:
      "Ejecutamos los trabajos de obra a realizar, según las disposiciones constructivas y la definición de los criterios de calidad técnica y estética, así también nos damos a la tarea de evaluar y controlar los criterios de calidad del proceso constructivo, surgidos de la documentación técnica. ",
  },
];
...
export const Services = () => {
  return (
    <section id="servicios">
      ...
      <ServicesIntro>
        <p>
          Nuestra misión es acompañar al cliente en el proceso, nucleando todos
          los procesos técnicos y administrativos en un solo actor, y de esta
          forma, generar que los desarrollos inmobiliarios sean efectivos en su
          materialización y ágiles en el tiempo.
        </p>
      </ServicesIntro>
